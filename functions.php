<?php
	...
	add_action( 'wp_enqueue_scripts', function(){
		...
		wp_enqueue_script('akvo-script', get_template_directory_uri() .'/js/akvo_scripts.js', array('jquery'), '1.0.6', true);
		...
		wp_enqueue_script('fontawesome-pro', 'https://use.fontawesome.com/641b62259f.js', array('jquery'), null, true);
		...
		wp_enqueue_style('style-chris', get_template_directory_uri() .'/assets/chris.css', array('bootstrap'), '1.0.5' );
