        ...
        jClocksGMT: function( options ) 
        {
            ...
            return this.each(function()
            {
                ...
                if( options.analog )
                {
                    ...
                    $("<img />", { class: "jcgmt-clock-hover", src: options.imgpath + 'images/jcgmt-' + options.skin + '-clock_face-hover.png' }).appendTo("#" + id + ' .jcgmt-clockHolder');
                }
				...
				$("<div />", { text: options.hello, class: "hellotext" }).appendTo("#" + id);
