...
<div class="fullwidth bg-light-gray  paddingtop paddingbottom">
	<div class="so-widget-sow-editor so-widget-sow-editor-base container counter centered">
		...
		<div class="row text-center">
			...
			<?php echo do_shortcode("[akvo_clock id='clock_east_africa' offset='+0' title='East Africa' hello='Jambo' link='https://akvo.org/east-africa/']");?>
			<?php echo do_shortcode("[akvo_clock id='clock_apac' offset='+0' title='Asia Pacific' hello='Apa kabar?' link='https://akvo.org/south-east-asia-pacific/']");?>
		</div>
	</div>
</div>
<!-- End World -->
