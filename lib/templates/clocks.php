...
<div class="fullwidth bg-light-gray  paddingtop paddingbottom">
	<div class="container counter">
		...
		<div class="row text-center">
			...
			<?php echo do_shortcode("[akvo_clock id='clock_europe' offset='+2' title='Europe' hello='Hello' link='']");?>
			...
			<?php echo do_shortcode("[akvo_clock id='clock_apac' offset='+7' title='South East Asia & Pacific' hello='Apu kabar' link='']");?>
		</div>
	</div>
</div>
<!-- End World -->
