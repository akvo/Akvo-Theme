...
<div class="fullwidth bg-light-gray  paddingtop paddingbottom">
	<div class="so-widget-sow-editor so-widget-sow-editor-base container counter centered">
		...
		<div class="row text-center">
			<?php echo do_shortcode("[akvo_clock id='clock_americas' offset='-5.0' title='Americas' hello='Hola' link='https://akvo.org/americas/']");?>
			...
			<?php echo do_shortcode("[akvo_clock id='clock_apac' offset='+7' title='South East Asia & Pacific' hello='Apa kabar?' link='https://akvo.org/south-east-asia-pacific/']");?>
		</div>
	</div>
</div>
<!-- End World -->
