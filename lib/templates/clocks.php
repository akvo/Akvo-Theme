...
<div class="fullwidth bg-light-gray  paddingtop paddingbottom">
	<div class="so-widget-sow-editor so-widget-sow-editor-base container counter centered">
		...
		<div class="row text-center">
			...
			<?php echo do_shortcode("[akvo_clock id='clock_west_africa' offset='+1' title='West Africa' hello='Salut' link='https://akvo.org/west-africa/']");?>
			<?php echo do_shortcode("[akvo_clock id='clock_europe' offset='+2' title='Europe' hello='Hello' link='https://akvo.org/europe/']");?>
			...
			<?php echo do_shortcode("[akvo_clock id='clock_apac' offset='+9' title='Asia Pacific' hello='Apa kabar?' link='https://akvo.org/south-east-asia-pacific/']");?>
		</div>
	</div>
</div>
<!-- End World -->
