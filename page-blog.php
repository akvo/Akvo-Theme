...
<?php if ( $query->have_posts() ) {	?>
	...
	<?php $temp_query2 = $wp_query2; $query3 = new WP_Query( 'post_type=post&order=DESC&orderby=date&posts_per_page=1' ); ?>
	<?php while ( $query3->have_posts() ) : $query3->the_post(); get_template_part('partials/article', 'col6'); endwhile; ?>
