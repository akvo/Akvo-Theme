		...
		<div class="process">
			<div class="process-row nav nav-tabs">
				...
				<div class="process-step">
					<button type="button" class="btn <?php if( $i ){ _e('btn-default'); } else{ _e('btn-info'); }?> btn-circle" data-toggle="tab" href="<?php _e( '#'.$process_menu_id.$i );?>"><i class="<?php _e( $item['fa_pro_icon'] );?> fa-3x"></i></button>
